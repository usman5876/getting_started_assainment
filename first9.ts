...
console.log(`hello ${persName}, would you like learn some typescript today?`);
*/
...
console.log(psname.toUpperCase());
console.log(psname.toLowerCase());
*/
...
/*
var authorName:string = "Hazarat Umar R.A";
console.log(`${authorName} once said,"The best way to defeat someone is to beat him at politeness."`);
*/
...
var message:string = "The best way to defeat someone is to beat him at politeness";
...
let msg: string= `My favourite number is ${fvrtNumber}`;
console.log (msg);
